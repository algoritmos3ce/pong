...
import algo3.pong.Action;
import algo3.pong.ActionMovePaddle;
import algo3.pong.ActionReset;
	...
	void setupMainLoop(Scene scene, GraphicsContext gc) {
        ...
        new AnimationTimer() {
			...
			public void handle(long now) {
				...
				elapsed += dt;
				while (elapsed > MS_PER_FRAME * 1_000_000) {
					elapsed -= MS_PER_FRAME * 1_000_000;
					pong.update(actions);
				}
